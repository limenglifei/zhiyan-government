(function () {
  ...
  new MutationObserver(() => { if (q('#chainReportV58')) { removeRiskSection(); if (q('#chainReportRowsV58')?.dataset.v72 !== '1' && q('#chainReportGapsV58')) enhanceGapLinkage(); } if (q('#nodeFilterModalV61:not(.hidden)')) patchPreferenceModal(); if (q('#nodeCompanyModal:not(.hidden)')) { patchLocalCompanyTable(); stripRecommendationContactPerson(); } }).observe(document.body, { childList: true, subtree: true });
})();
